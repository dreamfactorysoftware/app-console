<?php
/**
 * This file is part of the DreamFactory Console Application
 * Copyright 2013 DreamFactory Software, Inc. {@email support@dreamfactory.com}
 *
 * DreamFactory Console Application {@link http://github.com/dreamfactorysoftware/app-console}
...
if ( !class_exists( '\\Yii', false ) )
{
    ...
    while ( true )
    {
        ...
        echo 'Not in "' . $_dspBase . '" (' . $_path . ').<br/>';

        $_dspBase = '../' . $_dspBase;
        $_path = realpath( $_dspBase );

        if ( empty( $_dspBase ) || $_path == '.' || $_path == '/' )
        {
